...
//             <div className='flex flex-col gap-5 my-10'>
//                 <h1
//                     className='text-5xl font-bold ml-40 font-Montserrat'
...
//                         placeholder='Find your dream jobs'
//                         onChange={(e) => setQuery(e.target.value)}
//                         className='outline-none text-black-900 border-none w-full bg-transparent text-base py-2 pl-4'
//                     />
//                     <Button
//                         onClick={searchJobHandler}
//                         className="rounded-r-full bg-white text-base px-5 py-2 h-full flex items-center justify-center"
//                     >
//                         <Search className='h-5 w-5 text-black' />
//                     </Button>
//                 </div>
