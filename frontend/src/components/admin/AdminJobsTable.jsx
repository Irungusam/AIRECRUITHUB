  ...
  return (
    <div className="overflow-x-auto">
      <Table className="w-full table-auto border-collapse">
        ...
        <TableHeader>
          <TableRow>
            <TableHead className="text-left text-gray-800 dark:text-gray-200 font-medium">
              Company Name
            </TableHead>
            <TableHead className="text-left text-gray-800 dark:text-gray-200 font-medium">
              Role
            ...
            <TableHead className="text-right text-gray-800 dark:text-gray-200 font-medium">
              Action
            </TableHead>
          </TableRow>
        </TableHeader>
        <TableBody>
          {filterJobs?.map((job) => (
            ...
            >
              <TableCell className="py-4 px-6 text-gray-800 dark:text-gray-200">
                {job?.company?.name}
              </TableCell>
              <TableCell className="py-4 px-6 text-gray-600 dark:text-gray-400">
                {job?.title}
              </TableCell>
              <TableCell className="py-4 px-6 text-gray-500 dark:text-gray-500">
