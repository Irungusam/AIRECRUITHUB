            ...
            <div className='flex items-center justify-center w-screen my-10'>
                <form onSubmit={submitHandler} className='p-8 max-w-4xl w-full bg-white dark:bg-gray-800 shadow-xl rounded-lg border border-gray-300 dark:border-gray-700'>
                    ...
                    <div className='grid grid-cols-1 sm:grid-cols-2 gap-6'>
                        ...
                        <div>
                            <Label className="text-gray-800 dark:text-gray-200">Job Requirements</Label>
                            <Input
                                type="text"
                                name="requirements"
                                value={input.requirements}
                        ...
                        <div>
                            <Label className="text-gray-800 dark:text-gray-200">Years of Experience Required</Label>
                            <Input
                                type="number"
                                name="experience"
                                value={input.experience}
